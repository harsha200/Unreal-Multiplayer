...
#include "PuzzlePlatforms/Swat_Guy/MainAnimInstance.h"
...
// Cross Module References
	PUZZLEPLATFORMS_API UClass* Z_Construct_UClass_UMainAnimInstance_NoRegister();
	PUZZLEPLATFORMS_API UClass* Z_Construct_UClass_UMainAnimInstance();
	ENGINE_API UClass* Z_Construct_UClass_UAnimInstance();
	UPackage* Z_Construct_UPackage__Script_PuzzlePlatforms();
	PUZZLEPLATFORMS_API UFunction* Z_Construct_UFunction_UMainAnimInstance_UpdateAnimationProperties();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMainAnimInstance_UpdateAnimationProperties_Statics::Function_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Swat_Guy/MainAnimInstance.h" },
	};
#endif
...
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_bIsInAir;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMainAnimInstance_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMainAnimInstance_UpdateAnimationProperties, "UpdateAnimationProperties" }, // 2210855177
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMainAnimInstance_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "HideCategories", "AnimInstance" },
		{ "IncludePath", "Swat_Guy/MainAnimInstance.h" },
		{ "ModuleRelativePath", "Swat_Guy/MainAnimInstance.h" },
	};
#endif
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMainAnimInstance_Statics::NewProp_bIsInAir = { "bIsInAir", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMainAnimInstance, bIsInAir), METADATA_PARAMS(Z_Construct_UClass_UMainAnimInstance_Statics::NewProp_bIsInAir_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMainAnimInstance_Statics::NewProp_bIsInAir_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMainAnimInstance, 2766078904);
	template<> PUZZLEPLATFORMS_API UClass* StaticClass<UMainAnimInstance>()
	{
		return UMainAnimInstance::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMainAnimInstance(Z_Construct_UClass_UMainAnimInstance, &UMainAnimInstance::StaticClass, TEXT("/Script/PuzzlePlatforms"), TEXT("UMainAnimInstance"), false, nullptr, nullptr, nullptr);
